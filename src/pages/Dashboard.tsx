...
const Dashboard = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Upload a resume, add basics, and generate a tailored cover letter.",
      color: "bg-purple-500",
      route: "/cover-letter"
    },
    {
      ...
      description: "Choose role and skills; practice with AI-generated questions.",
      color: "bg-green-500",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-lg">
            Continue building your career with our AI-powered tools. You're making great progress!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold text-foreground mb-6">Your Career Tools</h3>
                  ...
                  >
                    <CardHeader className="pb-4">
                      <div className="flex items-center gap-4">
                        <div className={`p-3 rounded-full bg-gradient-primary group-hover:scale-110 transition-transform duration-300`}>
                          <IconComponent className="h-6 w-6 text-white" />
                        </div>
                        <div>
                    ...
                    <CardContent className="pt-0">
                      <Button 
                        ...
                        className={`
                          ...
                          ${service.icon === MessageSquare ? 'hover:bg-green-500' : ''}
                      ...
                      >
                        ...
                        {service.icon === MessageSquare && 'Start Mock Interview'}
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-primary text-white border-0">
              <CardContent className="p-6 text-center">
                ...
                <Button variant="hero" size="sm" className="bg-white text-primary hover:bg-white/90">
                  Upgrade Now
                </Button>
              </CardContent>
            </Card>
