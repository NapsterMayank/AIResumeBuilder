...
const CoverLetterGenerator = () => {
  ...
  const handleResumeUpload = async (file: File) => {
    try {
      ...
      const roleMatch = text.match(
        /(Engineer|Developer|Designer|Manager|Analyst|Scientist)/i
      );
  ...
  const downloadAsPdf = () => {
    ...
    w.document.write(`<!doctype html><html><head><title>Cover Letter</title>
      ...
      <h1>Cover Letter</h1><pre>${generatedLetter.replace(
        /</g,
        "&lt;"
      )}</pre></body></html>`);
    w.document.close();
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-card border-0 shadow-card">
              <CardHeader>
                ...
                <CardDescription>
                  We will pre-fill some details from your resume text.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <input
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tones.map((toneOption) => (
                      <Badge
                        key={toneOption.value}
                        variant={
                          tone === toneOption.value ? "default" : "secondary"
                        }
            ...
            <Card className="bg-gradient-primary text-white border-0">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-blue-100 mb-4">
                  AI will create a personalized cover letter based on your
                  inputs
                </p>
                <Button
                  variant="hero"
              ...
              <CardContent>
                {generatedLetter ? (
                  ...
                  <div className="text-center py-12 text-muted-foreground">
                    ...
                    <p>
                      Fill in the job details and click "Generate with AI" to
