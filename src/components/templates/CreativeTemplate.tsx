  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden print:shadow-none print:rounded-none resume-preview-content">
      <div className="h-full p-8 space-y-5 text-sm print:p-6 print:space-y-4">
        {/* Colorful Header */}
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 rounded-lg mb-6 print:p-4 print:mb-4">
        ...
        {/* Objective */}
        {data.objective && (
          <div className="print:break-inside-avoid bg-gray-50 p-4 rounded-lg">
            <h2 className="text-lg font-bold text-purple-900 mb-2 print:text-base print:mb-1 uppercase tracking-wide">
              Objective
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 print:grid-cols-1 print:gap-4">
          ...
          {data.experience.length > 0 && (
            <div className="print:break-inside-avoid">
              <h2 className="text-lg font-bold text-purple-900 mb-3 print:text-base print:mb-2 uppercase tracking-wide border-b-2 border-purple-200 pb-1">
                Experience
              </h2>
              <div className="space-y-4 print:space-y-3">
                {data.experience.map((exp) => (
                  <div key={exp.id} className="print:break-inside-avoid bg-white border border-purple-100 p-3 rounded">
                    <div className="flex justify-between items-start mb-1 print:mb-0">
                      <div className="flex-1">
                        <h3 className="font-bold text-purple-900 print:text-sm">
                          {exp.jobTitle}
                        </h3>
                        <p className="text-purple-700 italic print:text-xs">
                          {exp.company}
                          {exp.location && `, ${exp.location}`}
                        </p>
                      </div>
                      <div className="text-purple-600 text-right print:text-xs font-medium">
            ...
            <div className="print:break-inside-avoid">
              ...
              <div className="space-y-3 print:space-y-2">
                {data.education.map((edu) => (
                  <div key={edu.id} className="print:break-inside-avoid bg-white border border-purple-100 p-3 rounded">
                    <div className="flex justify-between items-start mb-1 print:mb-0">
                      <div className="flex-1">
                        <h3 className="font-bold text-purple-900 print:text-sm">
                          {edu.degree}
                        ...
                        {edu.gpa && (
                          <p className="text-purple-600 print:text-xs">
                            CGPA: {edu.gpa}
                          </p>
                        )}
                      </div>
                    ...
                    {edu.relevantCourses &&
                      edu.relevantCourses.filter((c) => c.trim()).length > 0 && (
                        <p className="text-purple-700 mt-1 print:text-xs print:mt-0">
          ...
          <div className="print:break-inside-avoid">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print:grid-cols-1 print:gap-3">
              {data.projects.map((project) => (
                <div key={project.id} className="print:break-inside-avoid bg-white border border-purple-100 p-4 rounded">
                  <div className="flex justify-between items-start mb-1 print:mb-0">
                    <div className="flex-1">
                      <h3 className="font-bold text-purple-900 print:text-sm">
                        {project.name}
                    ...
                    {project.link && (
                      <div className="text-right">
                        <a
                          href={project.link}
                          className="text-purple-600 text-xs hover:underline print:text-xs"
                        >
                          View Project
                        </a>
                      </div>
                  ...
                  {project.technologies.length > 0 && (
                    <p className="text-purple-600 text-xs mb-1 print:mb-0 mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 print:grid-cols-1 print:gap-4">
          ...
          {(data.skills.technical.length > 0 || data.skills.soft.length > 0) && (
            <div className="print:break-inside-avoid bg-gray-50 p-4 rounded-lg">
              <h2 className="text-lg font-bold text-purple-900 mb-3 print:text-base print:mb-2 uppercase tracking-wide">
                Skills
              </h2>
              <div className="space-y-2 print:space-y-1">
                {data.skills.technical.length > 0 && (
                  <div>
                    <span className="font-bold text-purple-900 print:text-sm">
                      Languages:
                    </span>{" "}
              ...
              <div className="space-y-2 print:space-y-1">
                {data.certifications.map((cert) => (
                  ...
                  >
                    ...
                    <div className="text-purple-600 text-right print:text-xs">
